export default function drawPath(graphics,path, tileWidth, tileHeight, color) {
    if (!path || path.length === 0) return;
  
    graphics.clear(); // Limpia solo el gráfico pasado como parámetro
  
    graphics.lineStyle(3, color, 1); // Configura el estilo de la línea (color amarillo y grosor de 3)
